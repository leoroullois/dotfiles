...
return packer.startup(function(use)
	...
	use({ "VDuchauffour/neodark.nvim", commit = "db4da2410b9429eaceaf2639220a31e736954ca3" })
	...
	use({
		...
		commit = "185bb91a0b692c54136663464e8225872c434637",
		run = "yarn install --frozen-lockfile && yarn compile",
	})
	-- LSP
	use({ "williamboman/mason.nvim", commit = "cd5f08caa0679d8af92ff9b45451eb6374b50668" })
	...
	-- Colorizer (+ tailwindcsss support)
